#!/usr/bin/env python3
"""
TemHumi Log Plotter - Interactive Version
Reads and plots temperature and humidity data from TemHumi.log file
Shows plot on screen AND saves as PNG file
"""
...
def plot_temhumi_log(log_file="TemHumi.log"):
    ...
    try:
        ...
        # Set window title
        fig.canvas.manager.set_window_title('TemHumi Data Visualization')
...
Temperature: {min(temperature_values):.1f}°C - {max(temperature_values):.1f}°C (avg: {sum(temperature_values)/len(temperature_values):.1f}°C)"""
        ...
        # Now show the plot on screen
        print("📊 Displaying plot on monitor...")
...
def main():
    ...
    print("TemHumi Log Plotter (Interactive + Save)")
    print("=" * 50)
